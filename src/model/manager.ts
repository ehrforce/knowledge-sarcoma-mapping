...
import { SarkomKnowledgeDatabase, MorphologyDataSet, morphologyRowToDataSet, AnatomyData, anatomyRowToDataSet } from './model';
...
export class KnowledgeManager {
    ...
    public static readonly TERM_ID_MORPHOLOGY = "ONK_MORF";
    public static readonly TERM_ID_ANATOMY = "ONK_ANATOMY";
